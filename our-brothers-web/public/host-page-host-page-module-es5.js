          ...
          _createClass(EditHostPageComponent, [
            ...
            },
            {
              ...
              value: function onUpdateMeeting(meetingDetails) {
                ...
                this.dataService
                  .updateMeeting(this.meeting.hostId, this.meeting.id, meetingDetails, this.year)
                  .subscribe(
                    function() {
                      ...
                      _this2.router.navigate([
                        'meetings/'
                          .concat(_this2.year, '/')
                          .concat(_this2.meeting.hostId, '/')
                          .concat(_this2.meeting.id)
                      ]);
                    },
                    function() {
    ...
    \**************************************************/
      ...
      function srcAppHostPageHostPageComponentTs(module, __webpack_exports__, __webpack_require__) {
        ...
        var HostPageComponent = /*#__PURE__*/ (function() {
          function HostPageComponent(router, authService, dataService, toastr, participationsService) {
            ...
            },
            {
              ...
              value: function getPlaceAutocomplete() {
                ...
                this.mapsAPILoader.load().then(function() {
                  var autocomplete = new google.maps.places.Autocomplete(_this6.addresstext.nativeElement, {
                  ...
                  google.maps.event.addListener(autocomplete, 'place_changed', function() {
                    ...
                    _this6.change.emit(parsedAddress);
                  });
                });
              }
            }
