...
(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ['participate-page-participate-page-module'],
  {
                    ...
                    if (currentStep > 0) {
                      if (user) {
                        if (
                          ...
                          _this.dataService.setUserRole(
                            user,
                            models__WEBPACK_IMPORTED_MODULE_3__['UserRole'].participate
                          );
                        }
                      }
        ...
        ParticipatePageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__['ɵɵdefineInjector']({
          ...
          imports: [
            [
              ...
              _shared_components_progress_progress_module__WEBPACK_IMPORTED_MODULE_6__['ProgressModule'], //ConfirmationDetailsModule,
    ...
    \******************************************************************************/
      ...
      /***/
      function srcAppParticipateParticipateIntroParticipateIntroComponentTs(
        module,
        __webpack_exports__,
        __webpack_require__
      ) {
