...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["participate-page-participate-page-module"], {
  ...
  function srcAppParticipatePageParticipatePageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _participate_intro_participate_intro_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    ...
    var _shared_components_meetings_meetings_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    ...
    function ParticipatePageComponent_section_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("submit", function ParticipatePageComponent_section_2_Template_app_participate_intro_submit_6_listener() {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("submit", function ParticipatePageComponent_section_2_Template_app_profile_form_submit_10_listener($event) {
          ...
          return ctx_r146.onProfileSubmit($event);
        });
    ...
    function ParticipatePageComponent_app_progress_4_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("joinMeeting", function ParticipatePageComponent_app_progress_4_Template_app_meetings_joinMeeting_1_listener($event) {
    ...
    var ParticipatePageComponent = /*#__PURE__*/function () {
      ...
      _createClass(ParticipatePageComponent, [{
        ...
        value: function onProfileSubmit(profileForm) {
          ...
          this.dataService.setUserProfile(this.user, profileForm); //this.curr=!this.curr
          ...
          if (window.confirm('האם ברצונך להשתבץ למפגש?')) {
            if (this.user.role !== models__WEBPACK_IMPORTED_MODULE_3__["UserRole"].bereaved) {
              ...
              this.dataService.participateJoinMeeting(this.user, meeting, accompanies).subscribe(function () {
                ...
                _this3.router.navigate(["meetings/".concat(_this3.year, "/").concat(meeting.hostId, "/").concat(meeting.id)]);
              }, function () {
