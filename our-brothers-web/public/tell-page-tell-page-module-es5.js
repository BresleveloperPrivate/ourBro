...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tell-page-tell-page-module"], {
  ...
  function srcAppTellBereavedGuidanceFormBereavedGuidanceFormComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_components_checkbox_checkbox_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    BereavedGuidanceFormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 15,
      vars: 2,
      consts: [[1, "medium-heading"], [1, "training-container"], [1, "training-text"], [1, "training-options"], ["href", "https://docs.google.com/forms/d/e/1FAIpQLSdysCMih5-VnB241KuP9zFbLyju9NqShDwntZHpBcUsGntqLg/viewform", "target", "_blank", 1, "site-link", "decoration", "sizetolink"], [1, "training-option", "not-interseted"], [3, "label", "checked", "checkedChanged"], [1, "site-button", "primary-button", "step-button", 3, "click"]],
      template: function BereavedGuidanceFormComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("checkedChanged", function BereavedGuidanceFormComponent_Template_app_checkbox_checkedChanged_12_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function BereavedGuidanceFormComponent_Template_button_click_13_listener() {
            return ctx.onSubmit();
          });
  ...
  function srcAppTellPageTellPageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_shared_services_user_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    var _shared_components_progress_progress_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ../../shared/components/progress/progress.component */
    "./src/app/shared/components/progress/progress.component.ts");
    /* harmony import */


    var _bereaved_intro_bereaved_intro_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ../bereaved-intro/bereaved-intro.component */
    "./src/app/tell/bereaved-intro/bereaved-intro.component.ts");
    /* harmony import */


    var _bereaved_profile_form_bereaved_profile_form_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ../bereaved-profile-form/bereaved-profile-form.component */
    "./src/app/tell/bereaved-profile-form/bereaved-profile-form.component.ts");
    /* harmony import */


    var _slain_form_slain_form_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ../slain-form/slain-form.component */
    "./src/app/tell/slain-form/slain-form.component.ts");
    /* harmony import */


    var _bereaved_guidance_form_bereaved_guidance_form_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ../bereaved-guidance-form/bereaved-guidance-form.component */
    "./src/app/tell/bereaved-guidance-form/bereaved-guidance-form.component.ts");
    /* harmony import */


    var _shared_components_meetings_meetings_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    ...
    var TellPageComponent = /*#__PURE__*/function () {
      ...
      router, authService, participationsService, toastr, _userService, dataService) {
        ...
        this.profile = false; //public ok: boolean = false;
      ...
      _createClass(TellPageComponent, [{
            ...
            if (currentStep > 0) {
              if (user) {
                if (user.role && user.role !== models__WEBPACK_IMPORTED_MODULE_3__["UserRole"].bereaved && !user.isAdmin) {
                  ...
                  _this5.dataService.setUserRole(user, models__WEBPACK_IMPORTED_MODULE_3__["UserRole"].bereaved);
                }
              }
        ...
        value: function onSlainsSubmit(slainForm) {
          ...
          alert('הפרטים נשמרו בהצלחה אפשר להמשיך להשתבץ למפגש'); // console.log('slain בדיקה');
          ...
          if (window.confirm('האם ברצונך להשתבץ למפגש?')) {
            if (this.user.role === models__WEBPACK_IMPORTED_MODULE_3__["UserRole"].bereaved) {
              this.dataService.bereavedJoinMeeting(this.user, meeting).subscribe(function () {
                ...
                _this6.router.navigate(["meetings/".concat(_this6.year, "/").concat(meeting.hostId, "/").concat(meeting.id)]);
              }, function () {
  ...
  function srcAppTellSlainFormSlainFormComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function SlainFormComponent_div_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SlainFormComponent_div_2_Template_button_click_15_listener() {
    ...
    var SlainFormComponent = /*#__PURE__*/function () {
      function SlainFormComponent(fb, utilsService, userService, router) {
      ...
      _createClass(SlainFormComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.userService.firebaseTellUser.subscribe(function (u) {
            ...
            if (u && u.bereavedProfile && u.bereavedProfile.slains && u.bereavedProfile.slains.length && u.bereavedProfile.slains.length > 0) {
        ...
        value: function initiateFrom(slain, story) {
          ...
          this.form = this.fb.group({
            firstName: [slain.firstName || '', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].maxLength(20), _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].pattern(this.utilsService.namePattern)]],
            lastName: [slain.lastName || '', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].maxLength(20), _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].pattern(this.utilsService.namePattern)]],
